// --- Entry door: scrolling stays locked until "Enter" is clicked. Once the door has been
// opened, it stays open for the rest of the session (refreshing the page or coming back via
// the "Home" menu link should not lock the visitor out again). ---
...
(function () {
  ...
  // Safety net: if the small "Skip Intro" button isn't visible or reachable on
  // some phones, tapping anywhere on the intro screen still skips straight to
  // the site.
